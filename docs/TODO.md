...
- **⚙️ Human deploy — migrations** — ✅ **025 + 026 run 2026-06-07** (client uploads + retention/rollup live). *(Confirm migration **024** from the invite/claim sprint is also run — invite/claim depends on it; not separately confirmed.)*
