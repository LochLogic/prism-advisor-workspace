...
let phasesData = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 'p2t6', label: 'Model extra principal in the mortgage payoff accelerator', tool: 'advanced' },
    ],
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 'p4t6', label: 'Set contribution priority for the year', tool: 'advanced' },
    ],
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 'p5t3', label: 'Enable systematic tax-loss harvesting', tool: 'discuss', seeTool: true },
      ...
      { id: 'p5t6', label: 'Review concentrated equity in the equity-comp planner', tool: 'advanced' },
    ],
